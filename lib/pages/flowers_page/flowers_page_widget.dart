...
import 'flowers_page_model.dart';
export 'flowers_page_model.dart';

class FlowersPageWidget extends StatefulWidget {
  const FlowersPageWidget({
    Key? key,
    required this.id,
  ...
  @override
  _FlowersPageWidgetState createState() => _FlowersPageWidgetState();
}

class _FlowersPageWidgetState extends State<FlowersPageWidget> {
  late FlowersPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FlowersPageModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: _model.flowerCollection(
        requestFn: () => ShopifyAdminGroup.flowersCategoryCall.call(),
      ),
      builder: (context, snapshot) {
        ...
        final flowersPageFlowersCategoryResponse = snapshot.data!;
