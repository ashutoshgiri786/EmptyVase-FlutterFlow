                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signin != 'Logged In') {
                                ...
                                _model.customerId = await actions.customerId();
                                ...
                                _model.wishlists = await ShopifyAdminGroup
                                    .getMetafieldsCall
                                    .call(
                                  customerId: functions.removeBetween(
                                      'Customer/',
                                ...
                                if (getJsonField(
                                  ...
                                  setState(() {
                                    FFAppState().wishlistProducts =
                                        (ShopifyAdminGroup.getMetafieldsCall
                                                .metafieldsKey(
                                      (_model.wishlists?.jsonBody ?? ''),
                                    ) as List)
                                ...
                                FFAppState().update(() {
                                  ...
                                  FFAppState().customerId =
                                      functions.removeBetween('Customer/', '}',
                                          _model.customerId!.toString());
                                  FFAppState().password =
                                      _model.passwordController.text;
                                });
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.signinSignin = await actions.signIn(
                                _model.emailController.text,
                                _model.passwordController.text,
                              );
                              if (_model.signinSignin != 'Logged In') {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('alert'),
                                      content: Text(_model.signinSignin!),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
                                ...
                                _model.customerInfoSignIn =
                                  ...
                                  customerid: functions.removeBetween(
                                      'Customer/',
                                      '}',
                                      _model.customerIdSignIn!.toString()),
                                );
                                _model.wishlistsSignIn = await ShopifyAdminGroup
                                    .getMetafieldsCall
                                    .call(
                                  customerId: functions.removeBetween(
                                      'Customer/',
                                ...
                                FFAppState().update(() {
                                  FFAppState().firstName = ShopifyAdminGroup
                                      .fetchCustomerInfoCall
                                      .firstName(
                                        (_model.customerInfoSignIn?.jsonBody ??
                                            ''),
                                      )
                                      .toString();
                                  FFAppState().lastName = ShopifyAdminGroup
